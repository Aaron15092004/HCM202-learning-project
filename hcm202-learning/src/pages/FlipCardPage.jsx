        ...
        <div className="game-intro-wrapper">
          ...
          <div className="game-header">
            <div className="game-name">
              <h1 data-text="HCM202">HCM202</h1>
            </div>
          </div>
          <div className="game-box-outer">
            <div className="game-logo">
              <p className="game-info info-uppercase">
                Chọn mức độ để bắt đầu thẻ ghi nhớ HCM202
              </p>
                    ...
                    <div className="game-back content-box instructions">
                      <div className="padded">
                        ...
                        <p>
                          ...
                          để tìm hai hình trùng nhau và củng cố nội dung HCM202.
                        </p>
                        <p>
              ...
              <p className="game-info">
                Thẻ ghi nhớ HCM202 giúp ôn tập nhanh các khái niệm và gợi ý quan trọng.
              </p>
            </div>
          </div>

          <footer className="footer-wrapper">
            &copy; Copyright {new Date().getFullYear()} HCM202 Learning. All
            rights reserved.
          </footer>
