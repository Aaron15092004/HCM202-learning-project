    ...
    <div className="triet-hoc-wrapper container-fluid p-4">
      ...
      >
        ...
        <p className="mb-0 fs-5">
          <i className="bi bi-lightbulb"></i> Học Tư tưởng Hồ Chí Minh theo từng chủ đề
        </p>
      </div>
      ...
      <div className="bg-white rounded-4 shadow p-4 mb-4">
        <div
          ...
          style={{ color: "var(--secondary-color)" }}
        >
          <i className="bi bi-journal-text"></i> Chọn chuyên đề HCM202:
        </div>
        <select
          id="topicSelect"
        ...
        >
          ...
          {coursesData.map((topic, index) => (
            <option key={topic.id} value={topic.id}>
              Chuyên đề {index + 1}: {topic.tieu_de}
            </option>
          ))}
        </select>
      </div>
